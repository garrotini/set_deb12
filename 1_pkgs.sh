...
sudo apt install -y xorg i3 i3status dmenu alacritty thunar zip ncdu curl xwallpaper rsync sudo vim tmux git htop neofetch x11-xkb-utils firefox-esr ffmpeg vlc ripgrep fzf
